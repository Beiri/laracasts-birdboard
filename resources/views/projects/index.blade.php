...
@section('content')
    ...
    <modal name="hello-world" classes="p-10 bg-card rounded-lg" height="auto">
        <h2 class="font-normal mb-16 text-center text-2xl">Let's Start Something New</h2>
        ...
        <div class="flex">
            <div class="flex-1 mr-4">
                ...
                <div class="mb-4">
                    ...
                    <textarea type="text" id="description" class="border border-muted-light p-2 text-xs block w-full rounded"
                        rows="7"></textarea>
                </div>
            </div>
